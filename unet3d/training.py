...
from unet3d.metrics import (dice_coefficient, dice_coefficient_loss, dice_coef, dice_coef_loss,
                            weighted_dice_coefficient_loss, weighted_dice_coefficient,weighted_bce,
                            categorical_crossentropy_loss, w_categorical_crossentropy_loss)
...
def load_old_model(model_file):
    ...
    custom_objects = {'dice_coefficient_loss': dice_coefficient_loss, 'dice_coefficient': dice_coefficient,
                      ...
                      '_loss': weighted_bce(0.85),
                      'categorical_crossentropy_loss': categorical_crossentropy_loss,
                      'w_categorical_crossentropy_loss': w_categorical_crossentropy_loss([1, 1, 1, 1, 1, 1, 1])}
    try:
